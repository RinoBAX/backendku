...
CREATE TABLE `users` (
    ...
    `bankName` ENUM('EMPTY', 'BCA', 'MANDIRI', 'UOB', 'CIMB', 'BNI', 'BRI') NOT NULL DEFAULT 'EMPTY',
    ...
    `previlegeStatus` BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE `project_fields` (
    ...
    `fieldType` ENUM('TEXT', 'TEXTAREA', 'DROPDOWN', 'IMAGE', 'FILE') NOT NULL,
...
CREATE TABLE `transactions` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `tipe` ENUM('PENGERJAAN_PROYEK', 'KOMISI_UPLINE_1', 'KOMISI_UPLINE_2', 'PENARIKAN_DANA', 'BONUS_OPERASIONAL') NOT NULL,
